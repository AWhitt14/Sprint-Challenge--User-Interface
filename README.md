...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    Semantic html is just where we use specific tags so people and computers understand can read the code easier
...
3. While using flexbox, what axis does the following property work on: ```align-items: center```?
    ...
    With a normal flex direction (row) the items will be centered along the vertical  axis, although if you change direction to column then it centers the item on the horizontal axis.

4. Explain why git is valuable to a team of developers.

    It allows for devs to pull documents from an online repository and create branches so we have backups.

5. Define mobile-first design in your own words.

    Mobile first is just where you design the website for mobile screens first and then add media query
